...
/* String declarations */
static std::string const __str_literal_1("%0x", 3u);
...
void MOD_mkTb::init_symbols_0()
{
  ...
  init_symbol(&symbols[1u], "RL_theadd", SYM_RULE);
}


/* Rule actions */

void MOD_mkTb::RL_theadd()
{
  tUInt8 DEF_x__h111;
  DEF_x__h111 = INST_fa.METH_fa_out((tUInt8)1u, (tUInt8)1u, (tUInt8)1u);
  dollar_display(sim_hdl, this, "s,2", &__str_literal_1, DEF_x__h111);
